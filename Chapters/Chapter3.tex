...
\chapter{Nhận diện chữ số viết tay} % Tên của chương
...
\begin{itemize}
    ...
    \item \textbf{adv\_grad\_norm}: Định mức để đo mức độ "nhiễu loạn đối nghịch". %Có 3 giá trị là 'infinity', 'l2', 'l1'.
\end{itemize}
...
\subsection{So sánh độ chính xác của hai mô hình dưới các mẫu "nhiễu loạn đối nghịch"}
...
\begin{figure}[h]
    ...
    \vspace{1.5cm}
    \includegraphics[width=\textwidth]{Image/test1_rel.png}
    % giãn cách giữa 2 hình
   
    \includegraphics[width=\textwidth]{Image/test2.png}
    \includegraphics[width=\textwidth]{Image/test2_rel.png}
